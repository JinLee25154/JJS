...
public class SetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ori_profile = getIntent().getParcelableExtra("home_to_set_profile");//사용자 사진
        imageview.setImageURI(ori_profile);//사용자 사진 set
        ...
        //설정에서 완료 버튼 누르면  입력한 유저 정보를 파이어베이스 데이터베이스에 전송
